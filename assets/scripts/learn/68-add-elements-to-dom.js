...
() => {
  ...
  beforeTargetElement.before(...beforeElement);
  ...
  afterTargetElement.after(...afterElement);

  // insertAdjacentElement()
  const elementInfo = {
    position: "afterend",
    element: createElement("span", "인접 요소로 삽입"),
  };
...
() => {
  ...
  // innerHTML
  // 자식으로 들어감
  // listElement.innerHTML = recipeHTMLTemplate;
...
// 여러 요소를 DOM에 추가할 때. DocumentFragment
// 문서 조각 객체. 실제 DOM과 유사(사용자가 보는 문서가 아닌 다른 공간)
(() => {
